// Stack Nutrition -- core solver logic, extracted from the chat prototype.
// Framework-agnostic vanilla JS. Port this into whatever frontend is chosen
// (e.g. as a TypeScript module) rather than using it as-is.
//
// The central idea: a meal has three primary food slots (protein, carb,
// fat). Because real foods carry more than one macro, the exact gram
// amount of each of the three foods needed to hit a meal's target is the
// solution to a 3x3 linear system, solved here via Cramer's rule.

// --- Daily targets -----------------------------------------------------

function computeDailyTargets({ calories, lbm, proteinRatioPerLbLbm, fatPctOfCalories }) {
...
// --- 3x3 linear solve (Cramer's rule) -----------------------------------
...
// foods are { p, c, f } grams of macro per gram of food (e.g. from
// usda_to_stack_nutrition.py output).
...
function solveMeal(meal, dailyTargets, foodLookup) {
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { computeDailyTargets, solve3x3, solveMeal };
}
